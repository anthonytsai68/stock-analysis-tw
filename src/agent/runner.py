    ...
    *,
    ...
    for step in range(max_steps):
        ...
        if response.tool_calls:
            ...
            if progress_callback:
                progress_callback(stream_event("generating", step=step + 1, message="正在生成最終分析..."))
