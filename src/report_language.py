...
SUPPORTED_REPORT_LANGUAGES = ("zh", "en", "ko", "zh-tw")
...
_OPERATION_ADVICE_TRANSLATIONS = {
    "strong_buy": {"zh": "強烈買入", "en": "Strong Buy", "ko": "적극 매수"},
    "buy": {"zh": "買入", "en": "Buy", "ko": "매수"},
    "hold": {"zh": "持有", "en": "Hold", "ko": "보유"},
    "watch": {"zh": "觀望", "en": "Watch", "ko": "관망"},
    "reduce": {"zh": "減倉", "en": "Reduce", "ko": "비중축소"},
    "sell": {"zh": "賣出", "en": "Sell", "ko": "매도"},
    "strong_sell": {"zh": "強烈賣出", "en": "Strong Sell", "ko": "적극 매도"},
}
...
_TREND_PREDICTION_TRANSLATIONS = {
    "strong_bullish": {"zh": "強烈看多", "en": "Strong Bullish", "ko": "강한 상승"},
    "bullish": {"zh": "看多", "en": "Bullish", "ko": "상승"},
    "sideways": {"zh": "震盪", "en": "Sideways", "ko": "횡보"},
    "bearish": {"zh": "看空", "en": "Bearish", "ko": "하락"},
    "strong_bearish": {"zh": "強烈看空", "en": "Strong Bearish", "ko": "강한 하락"},
}
...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "signal_attribution_heading": "信號歸因分析",
        ...
        "strongest_bullish_signal_label": "最強看多信號",
        "strongest_bearish_signal_label": "最強看空信號",
    },
    "en": {
